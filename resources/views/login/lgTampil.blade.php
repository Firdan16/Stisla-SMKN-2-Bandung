          ...
          <div class="p-4 m-3">
            ...
            <form method="POST" action="/authlogin" class="needs-validation" novalidate="">
              ...
              <div class="mt-5 text-center">
                Don't have an account? <a href="rgTambah">Create new one</a>
              </div>
            </form>

            <div class="text-center mt-5 text-small">
              Copyright &copy; Firdan Umar Arisyawal
            </div>
          </div>
        </div>
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="../assets/img/unsplash/smkn2.jpg">
